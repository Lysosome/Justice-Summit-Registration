...
<html lang="en">
  <head>
    ...
    <?php
      ...
      // doesn't need to be fixed because the $block variable is queried by integers, not user input. 
      function getSessionsByBlock($block) {

        global $con;

      	// NEW CODE TO REPLACE DEPRECIATED CODE
      	/*$stmt = $con->prepare("SELECT * FROM `sessions` WHERE `block` = :block");
      	$stmt->bind_param(":block", $block);
      	$stmt->execute();
      	$result = $stmt->fetchAll();*/
      	
      	$stmt = $con->prepare("SELECT * FROM `sessions` WHERE `block` = ?");
            ...
            <div class="panel-body">
              ...
              <table class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  $blocktimes = array(
                    "1" => "3/29, 11:30-12:20am",
                    "2" => "3/29, 1:00-1:50pm",
                    "3" => "3/30, 10:20-11:10pm",
                    "4" => "3/30, 11:20-12:10pm",
                  );
